                ...
                return (
                  <Link key={team.id} to={`/teams/${team.id}`} className="grid grid-cols-5 items-center px-4 py-3 text-sm hover:bg-[var(--bg-secondary)] transition-colors group">
                    <div className="col-span-2 flex items-center gap-2.5">
                      ...
                      <div className="w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold font-display text-white shadow-sm shrink-0" style={{ backgroundColor: team.primaryColor || '#ff7b35' }}>
